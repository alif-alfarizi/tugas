...
<head>
    ...
    <style>
        ...
        * {
        ...
        .search-button:hover {
            background-color:rgba(24, 173, 44, 0.74);
        }
        ...
        .social-icon:hover {
            background-color:rgba(53, 221, 31, 0.77);
        }
    ...
    <section class="products-container">
        <div class="products-grid">
            <div class="product-card">
                <img src="images/1.jpg" alt="Produk 1" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">coffe</h3>
                    <p class="product-price">Rp 20.000</p>
                </div>
            </div>

            <div class="product-card">
                <img src="images/2.jpg" alt="Produk 2" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">hot coffe</h3>
                    <p class="product-price">Rp 10.000</p>
                </div>
            </div>

            <div class="product-card">
                <img src="images/3.jpg" alt="Produk 3" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">dark coffe</h3>
